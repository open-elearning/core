...
txtEdit = txtEdit + '<div class="areaActiveSelect" onMouseDown="SelectWorkingI('+i+');" ></div>';
...
var p = '';
p += '<div onClick="appendSmartBlocs();" class="blocOelContents" >';
p += '</div>';
...
objTemp.realheight = objTemp.height;
objTemp.pageId = GPageId;
objTemp.text = getContentSmartBlocs();
objTemp.fontSize = 18;
CLudisAdd(objTemp);
lastUniKid = objTemp.unikid;
CLudisPaint();
...
function getContentSmartBlocs(){
return renderpluginoelcontentcardinfo();
}
...
var panLeft = parseInt((SCREEN_0_W/2) * zoomCanv) + decxCanv - 350;
var panTop  = 15;
